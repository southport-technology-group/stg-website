      ...
      <div>
        <ul className="flex lg:text-xl">
          <li className="lg:mr-5">
            <Link
              to="/about"
              className="inline-block py-1 pr-2 lg:p-0 border-b-2 border-blue-700 border-opacity-0 lg:hover:border-opacity-100 transition-all"
            >
              About
            </Link>
          </li>
          <li className="lg:mr-5">
            <Link
              to="/case-studies"
              className="inline-block py-1 px-2 lg:p-0 border-b-2 border-blue-700 border-opacity-0 lg:hover:border-opacity-100 transition-all"
            >
              Case Studies
            </Link>
          </li>
