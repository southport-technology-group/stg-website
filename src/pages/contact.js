        ...
        <div className="bg-white border border-blue-100 p-5 md:p-10 md:shadow-xl mb-10 md:w-8/12 lg:w-6/12">
          ...
          <label className="block mb-5">
            ...
            <input
              ...
              name="name"
              id="name"
              className="w-full bg-white border border-blue-400 mt-1 focus:border-blue-700 focus:ring-2 focus:ring-blue-200 text-base outline-none text-blue-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </label>
          <label className="block mb-5">
            Email
          ...
          <div className="flex justify-between items-center">
            <button
              type="submit"
              className="bg-blue-700 text-white hover:shadow-xl rounded py-2 px-4 font-bold"
            >
              Send
            </button>
          </div>
