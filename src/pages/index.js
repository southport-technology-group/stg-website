  ...
  <Layout>
      ...
      <div className="lg:container mx-auto flex flex-wrap md:flex-nowrap items-center">
        <div className="w-100 md:w-7/12 px-5 py-10 md:px-20 lg:pr-40 lg:py-20 xl:py-32">
          ...
          <p className="text-xl lg:text-2xl mb-10">
            We build products tailored to your needs that will save you time,
            make you money, and accelerate your growth.
          </p>
          <a
            href="/contact"
            className="inline-block text-xl bg-blue-700 text-white hover:shadow-xl py-3 px-5 font-bold"
          >
        ...
        <div className="w-100 md:w-5/12 md:pt-10 lg:pt-20 xl:-mb-20 md:pr-20">
          <img
            className="relative"
            src={TypingAtComputer}
            alt="Collaborating on a sketch"
          />
        </div>
      </div>
    </section>
    ...
    <section className="bg-blue-100">
      <div className="lg:container mx-auto py-10 md:py-20 lg:py-28 px-5 md:px-20">
        <h2 className="text-3xl lg:text-5xl">Services</h2>
        <span className="border-b-2 border-blue-400 w-24 my-5 block"></span>
        <div className="lg:w-8/12 mb-10">
          <p className="text-2xl">
            Our prices and terms are set up-front. No long-term contracts, no
            billing by the hour. Simple proposals and on-time delivery.
          </p>
        </div>
        <div className="lg:grid lg:grid-cols-3 lg:gap-10">
          <div className="bg-white border border-blue-200 p-10 shadow-xl mb-10">
            ...
            <p>
              We write the code. We provision the infrastructure. We buy your
              managed services. We won't invent something you can get off the
              shelf.
            </p>
          </div>
          <div className="bg-white border border-blue-200 p-10 shadow-xl mb-10">
            ...
            <p>
              We help you identify meaningful customer problems, experiment with
              solutions, and drive incremental revenue for your business through
          ...
          <div className="bg-white border border-blue-200 p-10 shadow-xl mb-10">
            ...
            <p>
              We work with business buyers to analyze the quality of an
              acquisition target's product & technology.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="lg:container mx-auto md:my-28 md:px-20 lg:mb-38">
      <div className="lg:flex lg:items-end relative">
        <img
          ...
          src={PointingAtComputerWide}
          alt="Two people looking at computer together"
        />
        <div className="bg-blue-700 p-10 xl:p-14 z-10 lg:absolute lg:right-0 xl:right-20 lg:-bottom-10 lg:w-5/12 xl:w-4/12">
          ...
          <p className="text-blue-100 text-lg">
            We deliver revenue-driving product improvements and simple,
            low-maintenance software solutions at a fixed price.
            <br />
            <br />
            Our iterative bid process ensures you know exactly what you're
            getting.
          </p>
        </div>
      </div>
